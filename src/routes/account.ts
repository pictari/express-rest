...
import { getAccountBlockedList, getAccountFriends, getAccountPendingFriendships, getPersonalAccountInfo, getPublicAccountShortened, getPublicAccountStatistics } from '../controllers/account';
...
//router.get('/:uuid/friends/:uuid2', endpointForAcceptingRequests);
router.get('/:uuid/blocks', getAccountBlockedList);

// change to auth route later
//router.post('/', endpointForNewAccount);

//router.post('/:uuid/friends/:uuid2', endpointForMakingFriends);
